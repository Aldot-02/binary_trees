...
/**
 * height - computes the height of a given tree.
 *
...
/**
 * swap - exchanges the positions of nodes when the child is greater than the parent
 *
...
/**
 * heap_insert - function that adds a value to a Max Binary Heap
